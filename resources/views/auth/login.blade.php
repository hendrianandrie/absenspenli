...
<head>
    ...
    <title>Login - SI-KASEP (Sistem Informasi Rekap Absen dan Nilai SMP Negeri 5 Ciamis)</title>
    <!-- Favicon Logo -->
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-6 stats-side">
                ...
                <div class="pt-3 mt-3 border-top border-white-10 text-white-50 small">
                    <i class="fa-solid fa-circle-info me-1"></i> Data diupdate real-time dari Sistem Informasi Rekap Absen dan Nilai SMP Negeri 5 Ciamis.
                </div>
            </div>
            ...
            <div class="col-lg-6 login-side">
                ...
                <div class="pt-4 mt-4 border-top text-center text-muted small">
                    &copy; {{ date('Y') }} SI-KASEP — Sistem Informasi Rekap Absen dan Nilai SMP Negeri 5 Ciamis
                </div>
            </div>
        </div>
    </div>
