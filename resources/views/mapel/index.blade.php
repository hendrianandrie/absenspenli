...
@if(!empty($isGuru) && $isGuru)
    <div class="alert alert-info border-0 shadow-sm mb-4">
        <i class="fa-solid fa-circle-info me-2"></i> Menampilkan pengaturan Mata Pelajaran, KKM & Bobot Penilaian yang Anda ampu (<strong>{{ Auth::user()->name }}</strong>).
    </div>
@endif

<div class="row g-4">
    @if(empty($isGuru) || !$isGuru)
        <!-- Form Tambah Mapel Baru (Khusus Admin) -->
        <div class="col-md-4">
        ...
        <div class="card card-custom p-4 bg-white shadow-sm">
            ...
            @if($mapels->isEmpty())
                <div class="text-center py-4 text-muted">
                    @if(!empty($isGuru) && $isGuru)
                        Belum ada mata pelajaran yang ditugaskan ke akun Anda oleh Admin.
                    @else
