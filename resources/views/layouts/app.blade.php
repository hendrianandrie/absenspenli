...
<head>
    ...
    <title>SI-KASEP - Sistem Informasi Rekap Absen dan Nilai SMP Negeri 5 Ciamis</title>
    <!-- Favicon Logo -->
...
<body>
    ...
    <footer class="bg-white border-top py-3 text-center text-muted fs-7 mt-auto">
        <div class="container">
            <small>&copy; {{ date('Y') }} SI-KASEP — Sistem Informasi Rekap Absen dan Nilai SMP Negeri 5 Ciamis</small>
        </div>
    </footer>
